...
![AWS connection form](https://pub-524d21c5655e4da5b4cbb0b0e80a6a7e.r2.dev/images/aws-credentials_123456789012_aws_dev-account.png)
...
![Connections page showing existing AWS dev account](https://pub-524d21c5655e4da5b4cbb0b0e80a6a7e.r2.dev/images/existing-connections_dev-account_24-08-2025_aws-credential.png)
...
![Filled AWS connection form with environment authorization](https://pub-524d21c5655e4da5b4cbb0b0e80a6a7e.r2.dev/images/aws-credentials_123456789012_aws_dev-account.png)
...
![Existing connections list with AWS dev account](https://pub-524d21c5655e4da5b4cbb0b0e80a6a7e.r2.dev/images/existing-connections_dev-account_24-08-2025_aws-credential.png)
...
![Connection details page showing AWS dev account details](https://pub-524d21c5655e4da5b4cbb0b0e80a6a7e.r2.dev/images/aws-dev-account-details_123456789012_24-08-2025.png)

...
![Deployment Component Store filtered to AWS components](https://assets.planton.ai/site/images/deployment-component-store_aws.png)
...
![Lego blocks filtered by AWS provider showing popular components](https://assets.planton.ai/site/images/deployment-component-store_aws.png)
...
![AWS connection form with environment authorization](https://assets.planton.ai/site/images/aws-credentials_123456789012_aws_dev-account.png)
...
![IAC Module Registry showing module details](https://assets.planton.ai/site/images/iac-module-registry_24-08-2025_planton-cloud.png)

...
![Connections page showing provider cards with Connect buttons](https://assets.planton.ai/site/images/docs/platform/existing-connections_dev-account_24-08-2025_aws-credential.png)
...
![AWS connection form with environment authorization checkboxes](https://assets.planton.ai/site/images/docs/platform/aws-credentials_123456789012_aws_dev-account.png)

4. Click **"Submit"**

**Success!** Your AWS account appears in "Existing Connections" and is ready to use.

![Existing connections list showing the newly connected AWS account](https://assets.planton.ai/site/images/docs/platform/existing-connections_dev-account_24-08-2025_aws-credential.png)
...
![Deployment Component Store with Lego Blocks tab selected](https://assets.planton.ai/site/images/docs/platform/deployment-component-store_aws.png)
...
![Search results showing AWS VPC component](https://assets.planton.ai/site/images/docs/platform/aws-vpc-overview_aws.png)
...
![Stack Job progress showing VPC creation steps](https://assets.planton.ai/site/images/docs/platform/deploy-aws-vpc_dev-1.png)
...
![Cloud Resources list showing the deployed VPC](https://assets.planton.ai/site/images/docs/platform/aws-vpc-overview_aws.png)

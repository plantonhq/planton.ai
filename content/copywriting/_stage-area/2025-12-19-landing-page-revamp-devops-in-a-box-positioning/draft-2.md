...
**What's Open Source:**
- Every Terraform module in the [Project Planton repository](https://github.com/plantonhq/project-planton)
...
**Why It Matters:**
Healthcare customers will require BAA to deploy production workloads handling patient data.

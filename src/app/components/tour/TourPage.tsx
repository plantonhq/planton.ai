...
import { Toaster } from '@/app/components/tour/ui/toaster';

type Callout = { number: number; x: number; y: number; title: string; description: string };
type TourStep = { step_number: number; title: string; description: string; image_url: string; callouts?: Callout[] };
...
const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    description:
      "Visualize and manage the stages of your deployment pipelines in real-time.",
    image_url:
...
export default function TourPage() {
        ...
        >
          <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full text-center">
            ...
            <div className="space-y-3">
              <Button onClick={handleScheduleDemo} className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white py-3 rounded-xl">
                Book Demo
              </Button>
              <Button variant="ghost" onClick={handleClosingContinue} className="w-full text-gray-500 hover:text-gray-700">
                Continue to Site
              </Button>
            </div>
          </div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-600 to-pink-500">
        ...
        >
          <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full text-center">
            ...
            <Button onClick={handleStart} className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white py-3 rounded-xl">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-600 to-pink-500" style={{ isolation: 'isolate' }}>
      <Toaster />
      <AnimatePresence>
        {showDemoPrompt && (
          <motion.div
          ...
          >
            ...
            >
              <button onClick={() => setShowDemoPrompt(false)} className="absolute top-4 right-4 text-gray-400 hover:text-gray-600 transition-colors">
                <X className="w-5 h-5" />
              </button>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Button variant="outline" onClick={handleKeepGoing} className="flex-1 border-2 border-gray-200 hover:border-purple-300 hover:bg-purple-50 text-gray-700">
                  Keep going
                </Button>
                <Button onClick={handleScheduleDemo} className="flex-1 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white">
                  Schedule demo
                </Button>
              </div>
            </motion.div>
      ...
      <div className="relative w-full h-screen p-4 md:p-8 flex items-center justify-center">
        <div className="max-w-6xl w-full h-[calc(100vh-160px)]">
          <AnimatePresence mode="wait">
            ...
            >
              <Image src={currentStepData.image_url} alt={currentStepData.title} fill sizes="100vw" className="object-contain" />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="mb-4">
              <div className="flex justify-between items-center mb-2">
                <span className="text-sm font-medium text-gray-700">Step {currentStep + 1} of {TOUR_STEPS.length}</span>
            ...
            <div className="flex justify-between items-center">
              ...
              <Button onClick={handleNext} className="flex items-center gap-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700">

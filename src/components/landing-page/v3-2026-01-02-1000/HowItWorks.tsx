...
// GitHub icon as inline SVG for styling control - kept for potential future use
const _GitHubIcon = () => (
...
const IaCIcon = () => (
  <Box className="flex items-center justify-center gap-2">
    <Image src="/images/providers/terraform.svg" alt="Terraform" width={48} height={48} className="w-9 h-9 md:w-10 md:h-10" />
    <Image src="/images/providers/pulumi.svg" alt="Pulumi" width={48} height={48} className="w-10 h-10 md:w-12 md:h-12" />
  </Box>
);
...
const GitProvidersIcon = () => (
  <Box className="flex items-center justify-center gap-3">
    <Image src="/images/providers/github-dark.svg" alt="GitHub" width={48} height={48} className="w-9 h-9 md:w-11 md:h-11" />
    <Image src="/images/providers/gitlab.svg" alt="GitLab" width={48} height={48} className="w-10 h-10 md:w-12 md:h-12" />
  </Box>
);
